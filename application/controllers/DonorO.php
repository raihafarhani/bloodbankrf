...
class DonorO extends CI_Controller {
	...
	public function index()
	{
		...
		//$data['result'] = $this->Model_donorO->getDonor($id);
		$this->load->view('donorO', $data);
	...
	public function form_input()
	{
		...
		$this->data['result'] = $this->Model_donorO->getDonor('donor');
	...
	public function insert() 
	{
		...
		$add = $this->Model_donorO->addDonor('donor', $data);
        if($add > 0){
			redirect('index.php/donorO');}
		else
	...
	public function delete($id){
		$delete = $this->Model_donorO->deleteDonor('donor', $id);
		if($delete > 0){
			redirect('index.php/donorO');}
		else
		   { echo 'Not Successfull';}
	...
	public function update($id) 
	{
		...
		$edit = $this->Model_donorO->dataEdit('donor', $data, $id);
        if($edit > 0){
			redirect('index.php/donorO');}
		else
		   { echo 'Not Successfull';}
