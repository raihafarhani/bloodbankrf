...
class DonorAA extends CI_Controller {
	...
	$this->db->where('BloodType', "A+");
		...
		//$data['result'] = $this->Model_donorAA->getDonor($id);
		$this->load->view('donorAA', $data);
	...
	public function form_input()
	{
		...
		$this->data['result'] = $this->Model_donorAA->getDonor('donor');
	...
	public function insert() 
	{
		...
		$add = $this->Model_donorAA->addDonor('donor', $data);
        if($add > 0){
			redirect('index.php/donorAA');}
		else
	...
	public function delete($id){
		$delete = $this->Model_donorAA->deleteDonor('donor', $id);
		if($delete > 0){
			redirect('index.php/donorAA');}
		else
		   { echo 'Not Successfull';}
	...
	public function update($id) 
	{
		...
		$edit = $this->Model_donorAA->dataEdit('donor', $data, $id);
        if($edit > 0){
			redirect('index.php/donorAA');}
		else
		   { echo 'Not Successfull';}
