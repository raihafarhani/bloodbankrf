...
.modal .modal-dialog {
    ...
    <!-- Navbar -->
<div class="w3-top">
  <div class="w3-bar w3-card w3-left-align w3-large bg-danger text-white">
    <a class="w3-bar-item w3-button w3-hide-medium w3-hide-large w3-right w3-padding-large w3-hover-white w3-large w3-red" href="javascript:void(0);" onclick="myFunction()" title="Toggle Navigation Menu"><i class="fa fa-bars"></i></a>
    <a href="<?php echo site_url('index.php/staff') ?>" class="w3-bar-item w3-button w3-padding-large w3-white">Staff</a>
    <a href="<?php echo site_url('index.php/donor') ?>" class="w3-bar-item w3-button w3-padding-large w3-white">Donor</a>
   	<a href="<?php echo site_url('index.php/stock') ?>" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Stock</a>
