						...
						<div class="table-responsive">
							<table id="userList" class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                   ...
                                   <td>
                                   <a href="<?php echo site_url('index.php/donor/form_edit/' .$r['DonorID']) ?>"><i class="fas fa-edit"></i></a>
                                   <a href="<?php echo site_url('index.php/donor/delete/' .$r['DonorID']) ?>"><i class="fas fa-user-times"></i></a>
                                    </td>
                                    </tr>      
                                    <?php } ?>    
                                    </tbody>
