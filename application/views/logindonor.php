            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        ...
                        <form id="login-form" class="form" action="<?php echo site_url('index.php/LoginDonor/checklogin') ?>" method="POST">
                        <h3 class="text-center text-danger">Donor Login</h3>
                            ...
                            <div id="register-link" class="text-right">
                                <a href="<?php echo site_url('index.php/register') ?>" class="text-danger">Register here</a>
                            </div>
                            </form>
                    </div>
                </div>
