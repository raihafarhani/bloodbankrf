...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="<?php echo site_url('index.php/admin') ?>" class="w3-bar-item w3-button w3-padding-large w3-white">Home</a>
    ...
    <a href="<?php echo site_url('index.php/donorO') ?>" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">O-</a>
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="container">
                   ...
                   <table>
                   <form action="<?php echo site_url('index.php/Email/email_all'); ?>" method="POST">
                   <tr>
...
foreach ($result as $r) { ?>
                   ...
                   <td><?php echo $r['Email'] ?><type="email" id="to" name="to"></td>
